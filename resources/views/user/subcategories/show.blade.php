                ...
                <div class="shop-top-bar mt-30">
                    <div class="shop-bar-inner">
                        ...
                        <div class="toolbar-amount">
                            <span>Showing {{ $subcategory->firstItem() }} to {{ $subcategory->lastItem() }}
                                of  {{$subcategory->total()}}</span>
                        </div>
                    </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="shop-add-action mb-xs-30">
                                                <ul class="add-actions-link">
                                                    ...
                                                    </li>                                                    <li class="wishlist"><a href="wishlist.html"><i class="fa fa-heart-o"></i>Add to wishlist</a></li>
                        ...
                        <div class="paginatoin-area">
                            <div class="row">
                                <div class="col show_pages">
                                    ...
                                    <p>Showing {{ $subcategory->firstItem() }} to {{ $subcategory->lastItem() }}
                                        of  {{$subcategory->total()}} </p>
                                </div>
                                <div class="col">
