                            ...
                            <li class="right-menu"><a href="#">{{$category->title}}</a>
                                <ul class="cat-mega-menu">
                                    ...
                                    <li class="right-menu cat-mega-title">
                                        <a
                                            href="{{route('category.show_sub',['category' => $category->id, 'subcategory' => $subcategory->id])}}">{{$subcategory->title}}</a>
                                        <ul>
                                            @foreach ( $subcategory->products as $product)
                                            <li><a
                                                    href="{{route('product.show',$product->id)}}">{{Illuminate\Support\Str::limit($product->title,20)}}</a>
                                            </li>
                                            @endforeach
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="{{route('product.show',$product->id)}}">
                                        <img src="/images/{{$product->images->first()->image}}"
                                        ...
                                        <ul class="add-actions-link">
                                            ...
                                            <li>
                                                ...
                                                <form action="{{route('wishlist.destroy',$product->id)}}" method="POST">
                                                    ...
                                                    @method('DELETE')
                                                    <input type="text" hidden name="id" value="{{$product->id}}">
                                                    <button class="links-details" href="single-product.html"><i
