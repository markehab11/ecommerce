...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">My Data /</span> Products</h4>

        <div class="card">
            <div class="table-header d-flex align-items-center">
                <h5 class="card-header">Products</h5>
                <a href="{{route('seller.products.create')}}" class="btn btn btn-primary ms-auto me-3">Add Product</a>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <form action="{{route('seller.products.restore',$product)}}" method="POST">
                                                @csrf
                                            ...
                                            @else
                                                <form action="{{route('seller.products.softDelete',$product)}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
