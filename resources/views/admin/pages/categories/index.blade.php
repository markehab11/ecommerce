...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">App Data /</span> Categories</h4>

        <div class="card">
            <div class="table-header d-flex align-items-center">
                <h5 class="card-header">Categories</h5>
                <a href="{{route('admin.categories.create')}}" class="btn btn btn-primary ms-auto me-3">Add Category</a>
            </div>
