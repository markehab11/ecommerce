...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">App Data /</span> About us</h4>

        <div class="card">
            <div class="table-header d-flex align-items-center">
                <h5 class="card-header">Sliders</h5>
                <a href="{{route('aboutus.create')}}" class="btn btn btn-primary ms-auto me-3">Add About us</a>
            </div>
...
{{--                                    <td><img src="{{asset('images/sliders/'. $slider->image ) }}" alt="" width="60" height="60"></td>--}}
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('aboutus.edit',$about->id)}}"
