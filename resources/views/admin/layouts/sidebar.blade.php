...
<div class="app-brand demo">
    ...
    <span class="app-brand-text demo menu-text fw-bolder ms-2">Shopy</span>
    </a>
...
<ul class="menu-inner py-1">
    ...
    <li class="menu-item {{(strpos(Route::currentRouteName(), "categories") !== false) ? 'active open' : '' }}">
        ...
        <ul class="menu-sub">
            <li class="menu-item {{(strpos(Route::currentRouteName(), ".categories") !== false) ? 'active' : '' }} ">
                <a href="{{route('admin.categories.index')}}" class="menu-link">
                    <div data-i18n="Categories">Categories</div>
                </a>
            </li>
{{--            <li class="menu-item {{(strpos(Route::currentRouteName(), ".subcategories") !== false) ? 'active' : '' }} ">--}}
{{--                <a href="{{route('admin.subcategories.index')}}" class="menu-link">--}}
{{--                    <div data-i18n="Categories">Sub Categories</div>--}}
{{--                </a>--}}
{{--            </li>--}}
        </ul>
    </li>
    <li class="menu-item {{ (strpos(Route::currentRouteName(), "products") !== false) ? 'active open' : '' }}">
        <a href="javascript:void(0)" class="menu-link menu-toggle">
            <i class="menu-icon tf-icons bx bx-shopping-bag"></i>
            <div data-i18n="User interface">Products</div>
        </a>
        <ul class="menu-sub">
            <li class="menu-item {{(strpos(Route::currentRouteName(), "products") !== false) ? 'active' : '' }}">
            <a href="{{route('admin.products.index')}}" class="menu-link">
                <div data-i18n="Accordion">Products</div>
            </a>
            </li>
            <li class="menu-item {{(strpos(Route::currentRouteName(), "Details product") !== false) ? 'active' : '' }}">
    ...
    <li class="menu-header small text-uppercase"><span class="menu-header-text">App Reports</span></li>
    ...
    <li class="menu-item">
        ...
        <ul class="menu-sub">
            ...
            <li class="menu-item">
            <a href="#" class="menu-link">
                <div data-i18n="Alerts">Products</div>
            </a>
            </li>
            <li class="menu-item">
            <a href="#" class="menu-link">
                <div data-i18n="Badges">Users</div>
            </a>
            </li>
    ...
    <!-- Components -->
    <li class="menu-header small text-uppercase"><span class="menu-header-text">App settings</span></li>

    <!-- User interface -->
    <li class="menu-item">
    <a href="javascript:void(0)" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bxs-bell-ring"></i>
        <div data-i18n="User interface">Push Notifications</div>
    </a>
    <ul class="menu-sub">
        <li class="menu-item">
        <a href="#" class="menu-link">
            <div data-i18n="Accordion">Bulk Notifications</div>
        </a>
        </li>
        <li class="menu-item">
        <a href="#" class="menu-link">
            <div data-i18n="Alerts">Private Notifications</div>
        </a>
        </li>
    ...
    <ul class="menu-sub">
        <li class="menu-item">
        <a href="#" class="menu-link">
            <div data-i18n="Perfect Scrollbar">Advanced</div>
        </a>
        </li>
        ...
        <li class="menu-item">
            <a href="#" class="menu-link">
                <div data-i18n="Text Divider">Dashboard</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="#" class="menu-link">
                <div data-i18n="Text Divider">Contact Info</div>
            </a>
        </li>
    </ul>
